...
- (UICollectionView *)contentScrollView
{
    if (_contentScrollView == nil) {
        ...
        //注册headerview
        [_contentScrollView registerClass:[UICollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"contentHeaderView"];
    }
...
//        titleExtraWidth = (screenWidth - titleWidth - addMenuViewW) / count;
//    }
...
//    [deleteBtn.layer setBorderColor:kSubjectColor.CGColor];
//
//    deleteBtn.titleLabel.font = kFontSize(13);
    [deleteBtn setTitle:@"排序删除" forState:UIControlStateNormal];
//    [deleteBtn setTitleColor:kSubjectColor forState:UIControlStateNormal];
...
//        _menuView.backgroundColor = kUIColor_RGB(255, 255, 255, 1.0);
        // 注册cell
...
//        slideMenucell.titleL.textColor = kSubjectColor;
        slideMenucell.deleteBtn.hidden = YES;
    }else {
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section {
    ...
    if (collectionView == self.contentScrollView) return CGSizeMake(0, 0);
    if (section == 0) {
...
{
    if (collectionView == self.contentScrollView) {
        UICollectionReusableView *headerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"contentHeaderView" forIndexPath:indexPath];
        return headerView;
    }
...
{
    if (scrollView == self.contentScrollView) _isAnimationing = NO;
}
